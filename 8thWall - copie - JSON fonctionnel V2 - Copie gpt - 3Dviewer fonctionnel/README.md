...
About this project
Learn more about how this project was made and how to make it your own in lesson 3 of 8cademy.

Project Components
xrextras-gesture-detector is required in your <a-scene> for xrextras gesture components to function correctly.
...
xrextras-one-finger-rotate lets the user drag across the screen with one finger to spin an object around its y axis.

factor: increase this number to spin more given the same drag distance (default: 6)
xrextras-two-finger-rotate lets the user drag across the screen with two fingers to spin an object around its y axis.
